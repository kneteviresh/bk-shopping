        ...
        >
            <Item>
              <Button transparent onPress={() => Actions.pop()}>
                <Icon name="close" size={32} style={{fontSize: 32}} />
              </Button>
              <Input
                placeholder="Search..."
                ...
                style={{marginTop: 9}}
              />
              <Icon name="search" onPress={() => this.search(this.state.searchText)} />
            </Item>
          </Header>
          {this.state.items.length <=0 ?
            <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
              <Icon name="search" size={38} style={{fontSize: 38, color: '#95a5a6', marginBottom: 7}} />
