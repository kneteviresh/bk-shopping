    ...
    var left = (
      <Left style={{flex:1}}>
        <Button transparent onPress={() => Actions.pop()}>
          <Icon name="close" size={38} style={{fontSize: 38}} />
        </Button>
      </Left>
    );
    return(
              ...
              <Grid style={{marginTop: 20, marginBottom: 10}}>
                ...
                <Col style={{paddingLeft: 5, paddingRight: 10}}>
                  <Button onPress={() => this.removeAllPressed()} style={{borderWidth: 1, borderColor: Colors.navbarBackgroundColor}} block iconRight transparent>
                    ...
                    <Icon style={{color: Colors.navbarBackgroundColor}} name='trash-outline' />
                  </Button>
                </Col>
              </Grid>
            </Content>
        ...
        >
          ...
          <Right>
            <Button style={{marginLeft: -25}} transparent onPress={() => this.removeItemPressed(item)}>
              <Icon size={30} style={{fontSize: 30, color: '#95a5a6'}} name='remove-circle-outline' />
            </Button>
          </Right>
        </ListItem>
      );
